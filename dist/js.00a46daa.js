      ...
      function (require, module, exports) {
        ...
        var preloader = function preloader(selector) {
          return new Promise(function (resolve) {
            ...
            _toConsumableArray(document.querySelectorAll(selector)).forEach(
              function (el) {
      ...
      function (require, module, exports) {
        ...
        var _win,
          ...
          _addNonTweeningPT = function _addNonTweeningPT(
            ...
            var pt = new _gsapCore.PropTween(
              plugin._pt,
              target,
              property,
              0,
            ...
            if (_transformProps[property] && property !== "transform") {
              ...
              if (
                ...
                value =
                  ...
                  (0, _gsapCore._getProperty)(target, property) ||
          ...
          _tweenComplexCSSString = function _tweenComplexCSSString(
            ...
            var pt = new _gsapCore.PropTween(
                ...
                0,
                1,
                _gsapCore._renderComplexString
              ),
              index = 0,
              matchIndex = 0,
              a,
              ...
              while ((result = _gsapCore._numWithUnitExp.exec(end))) {
                ...
                if (
                  ...
                  if (!endUnit) {
                    ...
                    endUnit =
                      endUnit || _gsapCore._config.units[prop] || startUnit;
          ...
          _specialProps = {
            clearProps: function clearProps(
              ...
              if (tween.data !== "isFromStart") {
                var pt = (plugin._pt = new _gsapCore.PropTween(
                  plugin._pt,
                  target,
                  property,
                  0,
  ...
  */
          ...
          _getComputedTransformMatrixAsArray =
            function _getComputedTransformMatrixAsArray(target) {
              ...
              return _isNullTransform(matrixString)
                ...
                : matrixString
                    .substr(7)
                    .match(_gsapCore._numExp)
                    .map(_gsapCore._round);
            },
          ...
          _parseTransform = function _parseTransform(target, uncache) {
            ...
            if (matrix !== _identity2DMatrix) {
              ...
              if (matrix.length === 6) {
                ...
                scaleX = (0, _gsapCore._round)(
                  Math.sqrt(a * a + b * b + c * c)
                );
                scaleY = (0, _gsapCore._round)(
          ...
          _renderSVGTransforms = function _renderSVGTransforms(ratio, cache) {
            ...
            if (xOrigin || yOrigin || xOffset || yOffset) {
              tx = (0, _gsapCore._round)(
                tx + xOrigin - (xOrigin * a11 + yOrigin * a12) + xOffset
              );
              ty = (0, _gsapCore._round)(
          ...
          _addRotationalPropTween = function _addRotationalPropTween(
            ...
            plugin._pt = pt = new _gsapCore.PropTween(
              plugin._pt,
              target,
              property,
              startNum,
          ...
          _addRawTransformPTs = function _addRawTransformPTs(
            ...
            for (p in _transformProps) {
              ...
              if (startValue !== endValue && exclude.indexOf(p) < 0) {
                ...
                endNum = parseFloat(endValue);
                plugin._pt = new _gsapCore.PropTween(
                  plugin._pt,
                  endCache,
                  p,
                  startNum,
        ...
        var CSSPlugin = {
          ...
          init: function init(target, vars, tween, index, targets) {
            ...
            for (p in vars) {
              ...
              if (
                _gsapCore._plugins[p] &&
                (0, _gsapCore._checkPlugin)(
                  p,
                  vars,
                  tween,
                  index,
              ...
              if (specialProp) {
                ...
                if (startAt && p in startAt) {
                  ...
                  startValue =
                    typeof startAt[p] === "function"
                      ...
                      : startAt[p];
                  p in _gsapCore._config.units &&
                    !(0, _gsapCore.getUnit)(startValue) &&
                    (startValue += _gsapCore._config.units[p]); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
                ...
                if (isTransformRelated) {
                  if (!transformPropTween) {
                    ...
                    transformPropTween = this._pt = new _gsapCore.PropTween(
                      this._pt,
                      style,
                      _transformProp,
                      0,
                  ...
                  if (p === "scale") {
                    this._pt = new _gsapCore.PropTween(
                      this._pt,
                      cache,
                      "scaleY",
                      cache.scaleY,
                ...
                if (
                  ...
                  endUnit =
                    (0, _gsapCore.getUnit)(endValue) ||
                    (p in _gsapCore._config.units
                      ? _gsapCore._config.units[p]
                      : startUnit);
                  startUnit !== endUnit &&
          ...
          getSetter: function getSetter(target, property, plugin) {
            ...
            return property in _transformProps &&
              ...
              : target.style &&
                !(0, _gsapCore._isUndefined)(target.style[property])
              ? _setterCSSStyle
              : ~property.indexOf("-")
              ? _setterCSSProp
              : (0, _gsapCore._getSetter)(target, property);
          },
          core: {
        ...
        (function (positionAndScale, rotation, others, aliases) {
          var all = (0, _gsapCore._forEachName)(
    ...
    "../node_modules/gsap/index.js": [
      function (require, module, exports) {
        ...
        var gsapWithCSS =
            _gsapCore.gsap.registerPlugin(_CSSPlugin.CSSPlugin) ||
            _gsapCore.gsap,
    ...
    "img/1.jpg": [
      function (require, module, exports) {
        module.exports =
          "https://images.unsplash.com/photo-1474600056930-615c3d706456?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2104&q=80";
      },
      {},
    ],
    "img/2.jpg": [
    ...
    "js/menuItem.js": [
      function (require, module, exports) {
        ...
        var splitting = (0, _splitting2.default)(); // track the mouse position
        ...
        var MenuItem = /*#__PURE__*/ (function () {
          function MenuItem(el, inMenuPosition, animatableProperties) {
            ...
            this.animatableProperties = animatableProperties; // create the image structure and split title texts
          ...
          _createClass(MenuItem, [
            {
              ...
              value: function layout() {
                ...
                this.DOM.revealImage.style.backgroundImage = "url(".concat(
                  images[this.inMenuPosition][1],
                  ")"
                );
                this.DOM.revealInner.appendChild(this.DOM.revealImage);
                this.DOM.reveal.appendChild(this.DOM.revealInner);
                this.DOM.el.appendChild(this.DOM.reveal); // title text/chars elements
                // text element

                this.DOM.textInner =
                  this.DOM.el.querySelector(".menu__item-text");
                ...
                this.DOM.textInner.appendChild(this.DOM.wordClone); // all text chars (Splittingjs)

                this.DOM.titleChars = _toConsumableArray(
                  this.DOM.word.querySelectorAll("span.char")
                );
                this.DOM.titleCloneChars = _toConsumableArray(
              ...
              value: function initEvents() {
                ...
                this.mouseenterFn = function () {
                  _this.hoverTimeout = setTimeout(function () {
                    _this.hoverEnter = true;
                    _this.firstRAFCycle = true; // calculate position/sizes the first time

                    _this.calcBounds();

                    _this.DOM.reveal.style.transformOrigin = "100% 0%"; // animate the title characters

                    _this.animateCharsIn(); // show the image element

                    _this.showImage(); // start the render loop animation (rAF)
                ...
                this.mouseleaveFn = function () {
                  ...
                  if (_this.hoverEnter) {
                    _this.hoverEnter = null; // stop the render loop animation (rAF)

                    _this.stopRendering();

                    _this.animateCharsOut(); // hide the image element
            ...
            {
              key: "animateCharsIn",
              value: function animateCharsIn() {
                this.animateCharsTimeline = _gsap.gsap
                  .timeline({
                    defaults: {
                      duration: 0.5,
                      ease: "power2",
            ...
            {
              key: "animateCharsOut",
              value: function animateCharsOut() {
                ...
                this.tl = _gsap.gsap
                  .timeline({
                    onStart: function onStart() {
                      ...
                      _gsap.gsap.set(
                        [_this2.DOM.reveal, _this2.DOM.revealInner],
                        {
                          opacity: 1,
                        }
            ...
            },
            {
              ...
              value: function render() {
                this.requestId = undefined; // calculate the mouse distance (current vs previous cycle)

                var mouseDistanceX = (0, _utils.clamp)(
                ...
                this.animatableProperties.tx.current = this.isPositionOdd
                  ? Math.abs(mousepos.x - this.bounds.el.left)
                  : Math.abs(mousepos.x - this.bounds.el.left) -
                    this.bounds.width;
                this.animatableProperties.ty.current = this.firstRAFCycle
                  ? this.bounds.height / 1.5
                  : Math.abs(mousepos.y - this.bounds.el.top); // new rotation value
                ...
                this.animatableProperties.brightness.current = this
                  .firstRAFCycle
                  ? 1
                  : (0, _utils.map)(mouseDistanceX, 0, 100, 1, 5); // set up the interpolated values
                ...
                this.animatableProperties.brightness.previous = this
                  .firstRAFCycle
                ...
                _gsap.gsap.set(this.DOM.reveal, {
                  ...
                  rotation: this.animatableProperties.rotation.previous, //filter: `brightness(${this.animatableProperties.brightness.previous})`
                }); // loop
      ...
      },
      {
        ...
        "splitting/dist/splitting-cells.css":
          "../node_modules/splitting/dist/splitting-cells.css",
        splitting: "../node_modules/splitting/dist/splitting.js",
      },
    ],
    "js/menu.js": [
      function (require, module, exports) {
        ...
        var Menu = /*#__PURE__*/ (function () {
          function Menu(el) {
            ...
            _toConsumableArray(this.DOM.menuItems).forEach(function (
              item,
              pos
            ) {
              return _this.menuItems.push(
                new _menuItem.MenuItem(item, pos, _this.animatableProperties)
              );
          ...
          _createClass(Menu, [
            {
              ...
              value: function showMenuItems() {
                var innerTexts = this.menuItems.map(function (item) {
      ...
      { gsap: "../node_modules/gsap/index.js", "./menuItem": "js/menuItem.js" },
    ],
    "js/cursor.js": [
      function (require, module, exports) {
        "use strict";
        ...
        var Cursor = /*#__PURE__*/ (function () {
          function Cursor(el) {
            ...
            this.onMouseMoveEv = function () {
              _this.renderedStyles.tx.previous =
                _this.renderedStyles.tx.current =
                  mouse.x - _this.bounds.width / 2;
              _this.renderedStyles.ty.previous =
                _this.renderedStyles.ty.previous =
                  mouse.y - _this.bounds.height / 2;
            ...
            },
            {
              ...
              value: function render() {
                ...
                for (var key in this.renderedStyles) {
                  this.renderedStyles[key].previous = (0, _utils.lerp)(
      ...
      { gsap: "../node_modules/gsap/index.js", "./utils": "js/utils.js" },
    ],
    "js/index.js": [
      function (require, module, exports) {
        "use strict";
        ...
        (0, _preloader.preloader)(".menu__item").then(function () {
          // initialize menu
          new _menu.Menu(menuEl);
        }); // initialize custom cursor

        var cursor = new _cursor.Cursor(document.querySelector(".cursor")); // mouse effects on all links and others

        _toConsumableArray(document.querySelectorAll("a")).forEach(function (
          link
        ) {
  ...
  {},
  ["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js", "js/index.js"],
  null
);
