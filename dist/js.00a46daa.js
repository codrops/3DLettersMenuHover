...
},{"./1.jpg":"NJSX","./2.jpg":"dFor","./3.jpg":"P8tY","./4.jpg":"kPmT","./5.jpg":"VqBz","./6.jpg":"gtVS"}],"oR66":[function(require,module,exports) {
...
var MenuItem = /*#__PURE__*/function () {
  ...
  _createClass(MenuItem, [{
    ...
    value: function layout() {
      ...
      this.DOM.titleChars = _toConsumableArray(this.DOM.word.querySelectorAll('span.char'));
      this.DOM.titleCloneChars = _toConsumableArray(this.DOM.wordClone.querySelectorAll('span.char'));
    ...
    value: function animateCharsIn() {
      this.animateCharsTimeline = _gsap.gsap.timeline({
        defaults: {
          duration: 0.5,
          ease: 'power2',
          stagger: 0.025
    ...
    value: function showImage() {
      ...
      this.tl = _gsap.gsap.timeline({
        onStart: function onStart() {
          ...
          _gsap.gsap.set([_this2.DOM.reveal, _this2.DOM.revealInner], {
            opacity: 1
    ...
    value: function render() {
      ...
      this.animatableProperties.ty.current = this.firstRAFCycle ? this.bounds.height / 1.5 : Math.abs(mousepos.y - this.bounds.el.top); // new rotation value

      var startingAngle = -30;
      this.animatableProperties.rotation.current = this.firstRAFCycle ? startingAngle : (0, _utils.map)(mouseDistanceX, 0, 300, startingAngle, cursorDirection.x < 0 ? startingAngle + 100 : startingAngle - 100); // new filter value

      this.animatableProperties.brightness.current = this.firstRAFCycle ? 1 : (0, _utils.map)(mouseDistanceX, 0, 100, 1, 5); // set up the interpolated values
...
},{"gsap":"TpQl","./utils":"MgTz","../img/*.jpg":"m7Bz","splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"oR66","splitting":"Qdhu"}],"i0CD":[function(require,module,exports) {
"use strict";
...
var Menu = /*#__PURE__*/function () {
  function Menu(el) {
    ...
    _toConsumableArray(this.DOM.menuItems).forEach(function (item, pos) {
      return _this.menuItems.push(new _menuItem.MenuItem(item, pos, _this.animatableProperties));
  ...
  _createClass(Menu, [{
    ...
    value: function showMenuItems() {
      ...
      _gsap.gsap.timeline().set(innerTexts, {
        x: '20%',
        opacity: 0
      }).to(innerTexts, {
        duration: 1,
...
exports.Menu = Menu;
},{"gsap":"TpQl","./menuItem":"Jy3L"}],"LMRJ":[function(require,module,exports) {
"use strict";
...
},{"./preloader":"BeZ8","./menu.js":"i0CD","./cursor":"LMRJ"}]},{},["QvaY"], null)